/*
Intrucciones:
Parte 1. Utilice el temporizador SysTick para alternar el led en la placa KL25z. 
Se debe usar un contador y su valor debe desplazarse 4 lugares a la derecha para 
que los cambios sean lo suficientemente lentos como para ser visibles en el LED 
de la placa (conecte la salida al LED rojo, PTB18)
*/
